...
let
  sources = {
    ...
    "hw-app-hash-git+https://github.com/obsidiansystems/hw-app-hash.git#a92c4aacaf13bba9bc62b6d4701a5fd724419f14" = {
      name = "hw-app-hash";
    ...
    "loupe-2.3.1" = {
      ...
      version = "2.3.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/loupe/-/loupe-2.3.1.tgz";
    ...
    "marked-4.0.11" = {
      ...
      src = fetchurl {
        ...
        sha512 = "xL2aJ5JDggqToKOqKHJWIDXaYk24XoGm1mNlhSPFP+0OKRCcKx+/hH7hlAr5LYqBKUzqCANylALgwNstVRgtCw==";
      };
    };
    "md5.js-1.3.5" = {
      name = "md5.js";
  ...
  args = {
    name = "hash-ledger-tests";
    packageName = "hash-ledger-tests";
    version = "0.1.0";
    src = ./.;
    dependencies = [
      ...
      sources."hw-app-hash-git+https://github.com/obsidiansystems/hw-app-hash.git#a92c4aacaf13bba9bc62b6d4701a5fd724419f14"
